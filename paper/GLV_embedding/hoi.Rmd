...
By choosing the candidate Lyapunov in Eq. \ref{eq:goh} function with weights $\gamma = (1,1,1, 2,2,2)^T$ and considering the perturbations $\Delta x = (y_1^2 - {y_1^\star}^2, y_2^2 - {y_2^\star}^2, y_3^2 - {y_3^\star}^2, y_1 y_2 - y_1^\star y_2^\star, y_1 y_3 - y_1^\star y_3^\star, y_2 y_3 - y_2^\star y_3^\star)^T$, we obtain:

\begin{equation}
\dot{V} = -\frac{2}{3} \left(y_1^2 + y_2^2 + y_3^2 - y_1 y_2 -y_1 y_3 - y_2 y_3 \right) \leq 0
\end{equation}

**A good proof of this? It is definitely true**

The derivative is thus negative for any $0<y_i<1$ but the equilibrium point, proving the stability of the equilibrium.
