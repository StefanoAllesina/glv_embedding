...
\title{Stability of ecological and epidemiological models via representation as
...
Mathematical, Physical and Engineering Sciences} 376 (2124). The Royal
Society Publishing: 20170384.
...
\emph{Physics Letters A} 268 (4-6). Elsevier: 335--41.

\leavevmode\hypertarget{ref-gleria2003numerical}{}%
Gléria, IM, A Figueiredo, and TM Rocha Filho. 2003. ``A Numerical Method
for the Stability Analysis of Quasi-Polynomial Vector Fields.''
...
Biosciences} 140 (1). Elsevier: 1--32.
...
Brenig. 2005. ``The Lotka--Volterra Canonical Format.'' \emph{Ecological
Modelling} 183 (1). Elsevier: 95--106.
